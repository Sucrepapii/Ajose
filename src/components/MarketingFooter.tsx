...
export function MarketingFooter() {
  return (
    <footer className="pt-20 pb-10 border-t border-white/5 bg-black text-sm">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-16">
          
          <div className="col-span-2 lg:col-span-2">
            <Link className="flex items-center gap-2 mb-6" href="/">
              <div className="bg-gradient-to-br from-emerald-400 to-emerald-600 p-1.5 rounded-xl shadow-[0_0_15px_rgba(16,185,129,0.2)]">
                <PiggyBank className="h-5 w-5 text-black" />
              </div>
              <span className="font-bold text-lg tracking-tight text-white">AjoCore</span>
            </Link>
            ...
            <div className="flex gap-4">
              ...
              <Link href="#" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-zinc-400 hover:bg-white/10 hover:text-white transition-all">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/#how-it-works" className="text-zinc-500 hover:text-white transition-colors">How it Works</Link></li>
              <li><Link href="/security" className="text-zinc-500 hover:text-white transition-colors">Security</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/cookies" className="text-zinc-500 hover:text-white transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-zinc-600">© {new Date().getFullYear()} AjoCore Technologies. All rights reserved.</p>
          <div className="flex items-center gap-4 text-zinc-600">
            <span>Made with trust globally.</span>
          </div>
        </div>
      </div>
    </footer>
